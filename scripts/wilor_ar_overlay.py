...
os.chdir(WILOR_DIR)   # WiLoR's config has relative paths; chdir so they resolve
...
def get_mano_faces(model):
    ...
    # Fallback: load directly from MANO_RIGHT.pkl
    import pickle
    pkl_path = WILOR_DIR / "mano_data" / "MANO_RIGHT.pkl"
